...
const MENU_RAW: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        // Cobranca do cliente final da empresa (template com GeraCobranca), nao a assinatura
        // SaaS da tela "cobrancas" acima.
        id: 'cobrancas-clientes', label: 'Cobranças de Clientes', route: '/cobrancas-clientes',
...
export const PAGE_TITLES: Record<string, string> = {
  ...
  cobrancas: 'Cobranças',
  'cobrancas-clientes': 'Cobranças de Clientes',
};
